...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Darshan Eshwarappa
        {/* hand-svg */}
            <svg
                  width="36"
                  height="36"
        ...
        <p className="home__description">I'm a budding Data Scientist based in Seattle, and I'm very passionate to my work.</p>
